        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-16">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tighter">Precision First</h3>
              <p className="text-gray-500 leading-relaxed font-medium">We maintain a strict tolerance standard of ±0.005mm across our CNC and fabrication lines, ensuring aerospace-grade reliability.</p>
            </div>
            <div className="space-y-6">
              <div className="w-16 h-16 bg-orange-50 text-industrial-orange rounded-2xl flex items-center justify-center">
                <span className="material-symbols-outlined text-3xl">security</span>
              </div>
              <h3 className="text-2xl font-black uppercase tracking-tighter">Security & Identity</h3>
              <p className="text-gray-500 leading-relaxed font-medium">Our printing division specializes in high-security identity media, deploying millions of encrypted smart cards globally.</p>
            </div>
            <div className="space-y-6">
              <div className="w-16 h-16 bg-green-50 text-green-600 rounded-2xl flex items-center justify-center">
                <span className="material-symbols-outlined text-3xl">eco</span>
              </div>
              <h3 className="text-2xl font-black uppercase tracking-tighter">Sustainability</h3>
              <p className="text-gray-500 leading-relaxed font-medium">All our facilities are ISO 14001 certified, utilizing closed-loop water systems and 100% recyclable PVC waste management.</p>
            </div>
          </div>
        </div>
      </section>
