...
const HomePage: React.FC<HomePageProps> = ({ onNavigate, onNavigateProduct, onNavigateEnquiry }) => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      {/* Hero Section */}
      <section className="bg-white dark:bg-deep-charcoal py-16 lg:py-24 border-b border-gray-50 dark:border-white/5 overflow-hidden relative transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-deep-charcoal dark:text-white leading-tight mb-8 transition-colors">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] bg-gray-100 relative group">
              <div className="absolute inset-0 bg-deep-charcoal/10 dark:bg-deep-charcoal/40 group-hover:bg-transparent transition-colors duration-500 z-10"></div>
              <img
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full bg-gray-50 dark:bg-slate-industrial -skew-x-12 opacity-50 pointer-events-none transition-colors duration-500"></div>
      </section>
      ...
      <section className="py-24 bg-background-light dark:bg-slate-industrial transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <p className="text-primary font-black text-[10px] uppercase tracking-[0.4em] mb-2">Division 01</p>
              <h2 className="text-2xl font-black text-deep-charcoal dark:text-white uppercase tracking-tighter transition-colors">Identity & Tracking Solutions</h2>
            </div>
            <button
              onClick={() => onNavigate('printing')}
